...
public class AmountCountJsonAllWindowApply implements AllWindowFunction<AnchorOrderJson.DataDTO,ItemCount, TimeWindow> {

    //Iterable 和 Collector的区别 多可以存放不同的数据类型
    //Iterable 迭代器
    //Collector 数据收集器
    @Override
    public void apply( TimeWindow window, Iterable<AnchorOrderJson.DataDTO> in, Collector<ItemCount> out) throws Exception {
