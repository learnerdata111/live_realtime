 ...
 */
@Slf4j
public class SinkToMySQL extends RichSinkFunction<ProductJson.DataDTO> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String sql = "INSERT INTO products_test (id, name,description) VALUES (?,?,?)";
        if (connection != null) {
     ...
     */
    @Override
    public void invoke(ProductJson.DataDTO value, Context context) throws Exception {
        if (ps == null) {
            return;
        }
        //组装数据，执行插入操作
